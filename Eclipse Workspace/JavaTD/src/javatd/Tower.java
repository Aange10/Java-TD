...
public class Tower {
	...
	public void testTowerAttributes() {
		
		// Display Prices and Attributes of Tower
		System.out.printf("Purchase: %d\t\tSale: %d\t\tUpgrade: %d\t\tLevel: %d\n", purchasePrice, salePrice, upgradePrice, upgradeLevel);
